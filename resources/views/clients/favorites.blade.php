            ...
            <div class="row ipad-width2">
                    ...
                    <div class="user-information">
                        ...
                        <div class="user-fav">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{url('user/favorites')}}">{{ __('Phim yêu thích') }}</a></li>
                                <li><a href="{{url('user/ratings')}}">{{ __('Phim đã đánh giá') }}</a></li>
                                <li><a href="{{url('user/reviews')}}">{{ __('Phim đã bình luận') }}</a></li>
                                <li><a href="{{url('user/upgrade-account')}}">{{ __('Cập nhật thành viên') }}</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="topbar-filter user">
                        <p>{{ __('Tìm thấy') }} <span>{{$favorites->count()}}</span> {{ __('phim') }}</p>
                    </div>
                    <div class="flex-wrap-movielist grid-fav">
                        @foreach($favorites as $favorite)
                            ...
                            <div class="hvr-inner">
                                <a href="{{url('movies/' . $favorite->film->id)}}"> {{ __('Chi tiết') }} </a>
                            </div>
