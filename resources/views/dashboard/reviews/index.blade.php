            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card patients-list">
                        <div class="header">
                            <h2><strong>Bình luận </strong><span>({{$reviews->total()}})</span></h2>
                        </div>
                        <div class="body">
                                ...
                                {{-- <div class="row clearfix">
                                    <div class="col-4">
                                        <select name="client" class="form-control z-index show-tick"
                                            ...
                                            <option value="" selected>-Tất cả người dùng-</option>
                                ...
                                <div class="tab-pane table-responsive active">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        @forelse($reviews as $review)
                                            <tr>
                                                <td>
                                                    <a href="{{route('dashboard.clients.index', ['searchKey' => $review->user->username])}}">{{$review->user->username}}</a>
                                                </td>
                                                <td>
                                                    <a href="{{route('dashboard.films.index', ['searchKey' => $review->film->name])}}">{{$review->film->name}}</a>
                                                </td>
                                                <td>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(".show_review").click(function () {
                    var review = $(this).val();
                    swal({
                        title: "<spna style='color: #8CD4F5'>Bình luận</span>",
