        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-5 col-sm-12">
                    <h2>Tất cả gói thành viên
                        {{-- <small class="text-muted">Welcome to Films</small> --}}
                    </h2>
                </div>
                <div class="col-lg-5 col-md-7 col-sm-12">
                    @if(auth()->guard('admin')->user()->hasPermission('create_memberships'))
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card patients-list">
                        <div class="header">
                            <h2><strong>Gói thành viên </strong><span>({{$memberships->total()}})</span></h2>
                        </div>
                        <div class="body">
                            <div class="col-5" style="padding-left: 0px">
                                <form action="{{ route('dashboard.memberships.index') }}" method="GET">
                                        ...
                                        @forelse($memberships as $membership)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if(auth()->guard('admin')->user()->hasPermission('delete_memberships'))
                                                        <form action="{{ route('dashboard.memberships.destroy', $membership) }}"
                                                              method="POST" style="display: inline-block">
                                                            @csrf
                                                            @method('DELETE')

                                                            <button type="submit"
                                                                    class="btn btn-icon btn-neutral btn-icon-mini remove_membership"
                                                                    title="Xoá" value="{{$membership->id}}">
