    ...
    <div class="movie-items">
        <div class="container">
            <div class="row ipad-width">
                <div class="col-md-12">
                    @if(count($suggestedFilms) > 0)
                    <div class="title-hd">
                        <h2>Phim đề xuất cho bạn</h2>
                            ...
                            <div class="tab active">
                                <div class="row">
                                    <div class="slick-multiItem" style="margin-top: 10px">
                                        @foreach($suggestedFilms as $key => $film)
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    <div class="mv-img">
                    ...
                    @foreach($categoryFilms as $category)
                        ...
                        <div class="tabs">
                            <ul class="tab-links">
                                <li><span style="color: lightslategray"> {{$category->films->count()}} Phim</span>
                                </li>
                            </ul>
