...
class CreateCommand extends Command
{
    ...
    public function createCommandFile()
    {
        ...
        $this->info('Created new Command ' . $this->argument('commandName') . 'Command.php in App\Commands.');
    }
    ...
    public function createHandlerFile()
    {
        ...
        $this->info(
            'Created new Command Handler ' . $this->argument('commandName') . 'Handler.php in App\CommandHandlers.'
        );
    }
